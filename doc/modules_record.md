## Node.js 如何处理 ES6 模块
(参考链接)[https://www.ruanyifeng.com/blog/2020/08/how-nodejs-use-es6-module.html]
js有两种格式的模块：
一种是ES6模块，简称ESM，另一种是Node.js 专用的COmmonJs 模块，简称CJS。两种模块不兼容

我们一般使用Node.js，只会用require()，遇到ES6模块不知所措，本文就来谈谈 ES6模块在Node.js 里面使用。
